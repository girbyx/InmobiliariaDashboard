...
namespace InmobiliariaDashboard.Server.Migrations
{
    ...
    [Migration("20210120072302_AddProspectAndTransfer")]
    partial class AddProspectAndTransfer
    {
            ...
            modelBuilder.Entity("InmobiliariaDashboard.Server.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "system",
                            CreatedOn = new DateTime(2021, 1, 20, 1, 23, 2, 466, DateTimeKind.Local).AddTicks(9309),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "system",
                            CreatedOn = new DateTime(2021, 1, 20, 1, 23, 2, 470, DateTimeKind.Local).AddTicks(4453),
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = "system",
                            CreatedOn = new DateTime(2021, 1, 20, 1, 23, 2, 470, DateTimeKind.Local).AddTicks(4580),
            ...
            modelBuilder.Entity("InmobiliariaDashboard.Server.Entities.Cost", b =>
                {
                    ...
                    b.Property<int?>("GainBankAccountId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InmobiliariaDashboard.Server.Entities.Gain", b =>
                {
                    ...
                    b.Property<int?>("CostBankAccountId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InmobiliariaDashboard.Server.Entities.Cost", b =>
                {
                    ...
                    b.HasOne("InmobiliariaDashboard.Server.Entities.BankAccount", "GainBankAccount")
                        .WithMany()
                        .HasForeignKey("GainBankAccountId");
            ...
            modelBuilder.Entity("InmobiliariaDashboard.Server.Entities.Gain", b =>
                {
                    ...
                    b.HasOne("InmobiliariaDashboard.Server.Entities.BankAccount", "CostBankAccount")
                        .WithMany()
                        .HasForeignKey("CostBankAccountId");
