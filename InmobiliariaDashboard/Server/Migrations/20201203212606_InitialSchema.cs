    ...
    public partial class InitialSchema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountCost", x => new { x.AccountsId, x.CostsId });
                    table.ForeignKey(
                        name: "FK_AccountCost_Accounts_AccountsId",
                        column: x => x.AccountsId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccountCost_Costs_CostsId",
                        column: x => x.CostsId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    AccountsId = table.Column<int>(type: "INTEGER", nullable: false),
                    GainsId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountGain", x => new { x.AccountsId, x.GainsId });
                    table.ForeignKey(
                        name: "FK_AccountGain_Accounts_AccountsId",
                        column: x => x.AccountsId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccountGain_Gains_GainsId",
                        column: x => x.GainsId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    AccountsId = table.Column<int>(type: "INTEGER", nullable: false),
                    LossesId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountLoss", x => new { x.AccountsId, x.LossesId });
                    table.ForeignKey(
                        name: "FK_AccountLoss_Accounts_AccountsId",
                        column: x => x.AccountsId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccountLoss_Losses_LossesId",
                        column: x => x.LossesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountCost_CostsId",
                table: "AccountCost",
                column: "CostsId");

            migrationBuilder.CreateIndex(
                name: "IX_AccountGain_GainsId",
                table: "AccountGain",
                column: "GainsId");

            migrationBuilder.CreateIndex(
                name: "IX_AccountLoss_LossesId",
                table: "AccountLoss",
                column: "LossesId");
